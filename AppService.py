...
class AppService:
    ...
    def obtain_daily_weather_data(self):
        start_date, end_date, daily_weather_variable, longitude, latitude = self.input_service.retrieve_daily_input_data_from_user(
